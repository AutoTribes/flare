    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          #
          # `excluded_lastnames` extended with "Form" and "Sandbox": both only
          # show up as one-off fully-qualified calls inside Phoenix-generated
          # boilerplate (lib/flare_web/components/core_components.ex,
          # test/support/data_case.ex) that we don't want to hand-edit just to
          # satisfy this check.
          {Credo.Check.Design.AliasUsage,
           [
             ...
             excluded_lastnames: ~w[Access Agent Application Atom Base Behaviour
                          ...
                          Tuple URI Version Form Sandbox]
           ]},
